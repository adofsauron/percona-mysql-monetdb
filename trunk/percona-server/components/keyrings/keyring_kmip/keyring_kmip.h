...
extern std::unique_ptr<keyring_common::operations::Keyring_operations<
    backend::Keyring_kmip_backend, keyring_common::data::Data_extension<IdExt>>>
...
/** Keyring data source */
extern std::unique_ptr<config::Config_pod> g_config_pod;

/** Keyring state */
extern bool g_keyring_kmip_inited;
