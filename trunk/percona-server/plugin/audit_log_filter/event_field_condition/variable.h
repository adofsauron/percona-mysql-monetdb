...
#ifndef AUDIT_LOG_FILTER_EVENT_FIELD_CONDITION_VARIABLE_H_INCLUDED
#define AUDIT_LOG_FILTER_EVENT_FIELD_CONDITION_VARIABLE_H_INCLUDED
...
class EventFieldConditionVariable : public EventFieldConditionBase {
  /*
...
#endif  // AUDIT_LOG_FILTER_EVENT_FIELD_CONDITION_VARIABLE_H_INCLUDED
