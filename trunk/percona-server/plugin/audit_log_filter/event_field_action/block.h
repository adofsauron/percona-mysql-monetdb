...
#ifndef AUDIT_LOG_FILTER_EVENT_FIELD_ACTION_BLOCK_H_INCLUDED
#define AUDIT_LOG_FILTER_EVENT_FIELD_ACTION_BLOCK_H_INCLUDED

#include "plugin/audit_log_filter/event_field_action/base.h"

namespace audit_log_filter::event_field_action {

class EventFieldActionBlock : public EventFieldActionBase {
 public:
  explicit EventFieldActionBlock(
...
#endif  // AUDIT_LOG_FILTER_EVENT_FIELD_ACTION_BLOCK_H_INCLUDED
