...
function(monetdb_hg_revision)
  ...
  if(EXISTS "${CMAKE_SOURCE_DIR}/storage/monetdb/.hg_archival.txt")
    file(READ "${CMAKE_SOURCE_DIR}/storage/monetdb/.hg_archival.txt" HG_ARCHIVAL)
  ...
  elseif(EXISTS "${CMAKE_SOURCE_DIR}/storage/monetdb/.hg")
    find_package(Hg)
    if(HG_FOUND)
  ...
  elseif(EXISTS "${CMAKE_SOURCE_DIR}/storage/monetdb/.git")
    find_package(Git)
    if(GIT_FOUND)
...
function(monetdb_debian_extra_files)
  install(FILES
    ${CMAKE_SOURCE_DIR}/storage/monetdb/misc/packages/deb/changelog
    ${CMAKE_SOURCE_DIR}/storage/monetdb/misc/packages/deb/copyright
    DESTINATION
...
function(find_selinux_types)
  ...
  if(AWK_FOUND)
    execute_process(COMMAND ${AWK_EXECUTABLE} "-f" "${CMAKE_SOURCE_DIR}/storage/monetdb/misc/selinux/selinux_types.awk" "/etc/selinux/config"
